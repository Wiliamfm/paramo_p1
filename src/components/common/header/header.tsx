  ...
  return (
    <div class="w-full h-full">
      ...
      <div class="w-full h-full"  onFocusIn$={() => {
        ...
        <div class="flex justify-evenly text-center text-gray-500 overflow-x-scroll dark:text-gray-400 p-4 w-5/6 mx-auto border-y-2 border-y-black dark:border-y-white">
